...
class StaffNote extends Table
{
    public function setup($param = []) 
    {
        ...
        $this->setupMaster(['table'=>TABLE_PREFIX.'staff','key'=>'staff_id','child_col'=>'location_id','child_prefix'=>'STF',
                            'show_sql'=>'SELECT CONCAT("Member: ",surname,", ",first_name) FROM '.TABLE_PREFIX.'staff WHERE staff_id = "{KEY_VAL}" ']);
