...
class StaffFile extends Upload
{
    public function setup($param = [])
    {
        ...
        $param = [];
        $param['table']     = TABLE_PREFIX.'staff';
        $param['key']       = 'staff_id';
        $param['label']     = 'name';
        $param['child_col'] = 'location_id';
        $param['child_prefix'] = $id_prefix;
        $param['show_sql'] = 'SELECT CONCAT("Staff: ",first_name," ",surname) FROM '.TABLE_PREFIX.'staff WHERE staff_id = "{KEY_VAL}" ';
