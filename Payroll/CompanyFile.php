...
class CompanyFile extends Upload
{
    public function setup($param = [])
    {
        ...
        $param = [];
        $param['row_name'] = 'Company document';
        $param['pop_up'] = true;
        ...
        $param = [];
        $param['table']     = TABLE_PREFIX.'company';
        $param['key']       = 'company_id';
        $param['label']     = 'name';
        $param['child_col'] = 'location_id';
        $param['child_prefix'] = $id_prefix;
        $param['show_sql'] = 'SELECT CONCAT("Company: ",name) FROM '.TABLE_PREFIX.'company WHERE company_id = "{KEY_VAL}" ';
