...
class StaffDepartmentFile extends Upload
{
    public function setup($param = [])
    {
        ...
        $param = [];
        $param['row_name'] = 'Staff department document';
        $param['pop_up'] = true;
        ...
        $param = [];
        $param['table']     = TABLE_PREFIX.'staff_department';
        $param['key']       = 'department_id';
        $param['label']     = 'name';
        $param['child_col'] = 'location_id';
        $param['child_prefix'] = $id_prefix;
        $param['show_sql'] = 'SELECT CONCAT("Staff department: ",name) FROM '.TABLE_PREFIX.'staff_department WHERE department_id = "{KEY_VAL}" ';
